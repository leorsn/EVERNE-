...
export const previewProducts: PreviewProduct[] = [
  ...
  },
  {
    ...
    sku: 'EV-RS-01',
    price: '€149',
    description: 'A complete four-tool wardrobe-care routine for refreshing, restoring and maintaining the garments you keep: Steam Brush, Electronic Lint Remover, Cashmere Comb and Fabric Care Brush.',
    ...
    facts: ['Steam Brush', 'Electronic Lint Remover', 'Cashmere Comb', 'Fabric Care Brush'],
    included: ['Steam Brush', 'Electronic Lint Remover', 'Cashmere Comb', 'Fabric Care Brush'],
    benefits: [
      ...
      { title: 'Finish', copy: 'Use the Fabric Care Brush for quick surface upkeep when a lighter manual intervention is enough.' },
    ],
