...
export const previewProducts: PreviewProduct[] = [
  ...
  },
  {
    ...
    alt: [
      'Manual fabric care brush on a warm beige studio background',
      'Close-up of the manual fabric care brush on a warm beige studio background',
      'Manual fabric care brush in use on beige wool fabric',
    ],
    facts: ['Manual', 'Double-sided head', 'Lightweight format'],
    benefits: [
      { title: 'Everyday upkeep', copy: 'Made for quick passes over visible lint, loose fibres and surface debris on suitable fabrics.' },
    ...
    howToUse: 'Work gently over the fabric surface using light, controlled strokes. Avoid loose threads, embellishments and delicate areas.',
    care: 'Always follow the garment care label and test delicate or unfamiliar fabrics on an inconspicuous area first.',
    details: ['Manual double-sided care head', 'No charging or cable required', 'Lightweight format', 'For visible lint, loose fibres and surface debris on suitable fabrics'],
  },
  {
    number: '04',
    title: 'Steam Brush',
  ...
  },
  {
    ...
    sku: 'EV-RS-01',
    price: '€129',
    description: 'A complete three-tool wardrobe-care routine for refreshing, restoring and maintaining the garments you keep: Steam Brush, Electronic Lint Remover and Cashmere Comb.',
    ritual: 'Three tools. One wardrobe-care system.',
    ...
    facts: ['Steam Brush', 'Electronic Lint Remover', 'Cashmere Comb'],
    included: ['Steam Brush', 'Electronic Lint Remover', 'Cashmere Comb'],
    benefits: [
    ...
    details: ['Three complementary wardrobe-care tools', 'Individual value €161', 'System price €129', 'Save €32 compared with buying the three tools individually'],
  },
];
